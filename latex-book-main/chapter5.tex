...
\begin{enumerate}
    ...
    \begin{itemize}
        \item \textbf{Chuẩn an toàn giao dịch}: Mọi thủ tục đều kích hoạt \texttt{SET XACT\_ABORT ON;} kết hợp khối \texttt{BEGIN TRY ... BEGIN CATCH} và kiểm tra \texttt{IF @@TRANCOUNT > 0 ROLLBACK TRANSACTION;} để đảm bảo tính nguyên tử (Atomicity), tự động hoàn nguyên khi có ngoại lệ phát sinh.
        ...
        \item \texttt{verification.usp\_record\_verification\_decision}: Ghi nhận quyết định thẩm định của Ban tổ chức và đồng bộ trạng thái bài thi theo cơ chế chuyển đổi một chiều an toàn.
