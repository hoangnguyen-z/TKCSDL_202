...
\begin{equation*}
\begin{split}
\text{User/Role} &\rightarrow \text{Participant} \rightarrow \text{Registration} \rightarrow \text{Film Roll} \rightarrow \text{Film Frame} \\
&\rightarrow \text{Submission} \rightarrow \text{Verification} \rightarrow \text{Judging} \rightarrow \text{Result} \rightarrow \text{Archive}
\end{split}
\end{equation*}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        $\text{JudgeAssignment } (1,1) \longleftrightarrow (1,N) \text{ Judge}$: Phân công giám khảo vào vòng thi.
        \item $\text{Evaluation } (1,1) \longleftrightarrow (1,N) \text{ EvaluationScore}$; \\
        $\text{EvaluationScore } (1,1) \longleftrightarrow (1,N) \text{ ScoringCriterion}$: Phiếu chấm chứa điểm theo tiêu chí.
        \item $\text{Result } (1,1) \longleftrightarrow (0,N) \text{ AwardAssignment}$; \\
        $\text{AwardAssignment } (1,1) \longleftrightarrow (1,1) \text{ AwardDefinition}$: Gán giải thưởng chung cuộc.
