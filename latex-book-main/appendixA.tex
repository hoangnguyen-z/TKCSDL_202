...
BEGIN TRY
    EXEC submission.usp_create_submission
        ...
        @scanned_image_uri = 
            N'https://storage.cloud/submissions/sub_dup.jpg',
        @actor_user_id = 1,
...
END TRY
BEGIN CATCH
    PRINT 'TEST PASS: Đã chặn thành công khung hình nộp trùng!';
...
BEGIN TRY
    ...
    INSERT INTO judging.Evaluation (
        ...
        evaluation_status, total_score
    ) VALUES (1, 1, 3, 'SUBMITTED', 85.50);

    -- Lần 2: Giám khảo 3 cố tình chấm lại bài thi 1 trong Vòng 1
    INSERT INTO judging.Evaluation (
        round_id, submission_id, judge_user_id, 
        evaluation_status, total_score
...
END TRY
BEGIN CATCH
    PRINT 'TEST PASS: Đã chặn phiếu chấm trùng của Giám khảo.';
