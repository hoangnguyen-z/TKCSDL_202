...
Toàn bộ 24 kịch bản kiểm thử T-SQL tự động trong thư mục \texttt{tests/} đã được thực thi và xác nhận vượt qua 100\% trên môi trường Microsoft SQL Server thực tế, phân chia thành 3 nhóm kiểm thử nghiệp vụ chuyên biệt (Bảng~\ref{tab:c6_tests}):

\begin{table}[htbp]
\centering
\scriptsize
\begin{tabularx}{\textwidth}{>{\bfseries\ttfamily}p{2.8cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{2.9cm}}
\toprule
...
\midrule
\multicolumn{3}{l}{\textbf{Nhóm 2: Thủ tục Lưu trữ Nghiệp vụ và Kiểm soát Giao dịch}} \\
\midrule
...
\midrule
\multicolumn{3}{l}{\textbf{Nhóm 3: Chấm thi, Hàm Tính toán, Xếp hạng và Lưu trữ Di sản}} \\
\midrule
...
TST-ARC-001 & Tạo bản chụp di sản số (Snapshot) cho tác phẩm đoạt giải & \textbf{PASS} (Snapshot chuẩn) \\
...
\bottomrule
\end{tabularx}
\caption{Kết quả thực thi bộ 24 kịch bản kiểm thử tự động T-SQL}
\label{tab:c6_tests}
\end{table}
