...
\textbf{UC-04} & Participant nộp frame & Registration \texttt{APPROVED}/\texttt{ELIGIBLE}, frame \texttt{READY}, submission window mở & Chọn category, lưu URI scan và statement; quá hạn, sai ownership hoặc trùng frame thì rollback & Submission; \texttt{DRAFT -> PENDING\_VERIFICATION}; Submission, AuditLog; BR-O-003, BR-O-005, BR-P-006, BR-P-009 \\
...
\textbf{UC-07} & Organizer finalize result & Final round đủ evaluation \texttt{SUBMITTED}/\texttt{LOCKED} & Aggregate score, xử lý tie, gán award và publish; thiếu evaluation thì chặn & Result; \texttt{DRAFT -> FINALIZED -> PUBLISHED}; Result, AwardAssignment, AuditLog; BR-O-010, BR-P-014, BR-P-015, BR-P-016 \\
