...
\begin{enumerate}
    ...
    \item Kiến trúc đích giả định tệp nhị phân của hình ảnh được lưu trữ tại dịch vụ lưu trữ đối tượng (\textit{Object Storage}); trong phase này chưa triển khai dịch vụ đó, cơ sở dữ liệu chỉ lưu trữ đường dẫn (\textit{URI/Path}), mã băm kiểm tra toàn vẹn (\textit{SHA-256 hash}) và siêu dữ liệu kỹ thuật.
\end{enumerate}
