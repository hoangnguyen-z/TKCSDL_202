...
\begin{itemize}
    ...
    \item \textbf{SQL Server Container}: Chạy image chính thức \texttt{mcr.microsoft.com/mssql/\allowbreak server:\allowbreak 2022-CU24-ubuntu-22.04}, kết nối qua cổng TCP 1433 với ổ đĩa gắn ngoài (\textit{Persistent Volume}) đảm bảo an toàn dữ liệu khi khởi động lại container.
