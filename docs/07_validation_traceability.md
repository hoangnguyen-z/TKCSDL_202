...
| FR-013, FR-014, FR-015, BR-P-006, BR-P-009 | F04 / UC-04 | Submission Management | Submission | Submission | `submission.Submission`, `submission.usp_create_submission` | Submission uniqueness, deadline validation, invalid FK/status/date tests: `TST-INT-001`, `TST-INT-002`, `TST-INT-004`, `TST-SUB-001`, `TST-SUB-002` |
...
| FR-020, FR-021, FR-022, FR-023, BR-O-008, BR-O-009 | F06 / UC-06 | Judging | JudgeAssignment, Evaluation, EvaluationScore | JudgeAssignment, Evaluation, EvaluationScore | `judging.JudgeAssignment`, `judging.Evaluation`, `judging.EvaluationScore` | Duplicate evaluation unique key, score checks, `TST-JDG-001`, `TST-INT-003` |
...
| FR-028, BR-O-011, BR-P-017 | F08 / UC-08 | Digital Archive | ArchiveItem | ArchiveItem | `archive.ArchiveItem`, `reporting.vw_archive_catalog` | `UQ` on result archive, archive stability and restricted-delete tests: `TST-ARC-001`, `TST-RET-001` |
